  ...
  return (
    <section className={`${props.params.styles || ''} py-10 lg:py-16`} id={id ? id : undefined}>
      <div className="container">
        <div
          className={`grid grid-cols-1 overflow-hidden border shadow transition-shadow hover:shadow-lg lg:grid-cols-2 ${hideShadow ? '' : 'shadow hover:shadow-lg'} `}
        >
          {/* Image Section */}
...
export const MarketplaceTile = (props: PromoProps): JSX.Element => {
  const id = props.params.RenderingIdentifier;
